#!/bin/bash
#SBATCH --mem=80GB
#SBATCH -o cameraReady_quevedo_ablating_cws.out
...
python ../mlp_implementations.py \
    --features cis_sentence_mean cis_sentence_max vanilla_entropy_sentence_mean vanilla_entropy_sentence_max surprisal_sentence_mean surprisal_sentence_max\
    --model $model \
    --output_dir ../../sentence-level/cameraReady_quevedo \
    --remarks cameraReady_quevedo_ablating_cws \
    --save
